    ...
    <div className="CustomerComment-container">
      <div className="CustomerComment">
        ...
        <div className="additional-comments">
          ...
          <textarea rows="4" cols="50" placeholder="Enter any comments here"></textarea>
          <div className="anonymous-checkbox">
            <input type="checkbox" id="anonymousComment" name="anonymousComment" />
            <label htmlFor="anonymousComment">Leave a comment anonymously</label>
          </div>
        </div>
        </div>
